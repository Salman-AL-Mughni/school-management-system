                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('exams.Add a new test') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('exams.Test name') }}</th>
                                            <th>{{ trans('exams.name teacher') }}</th>
                                            <th>{{ trans('exams.Educational level') }}</th>
                                            <th>{{ trans('exams.Classroom') }}</th>
                                            <th>{{ trans('exams.Section') }}</th>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm"
                                                            ...
                                                            class="fa fa-trash"></i></button>
                                                                     ...
                                                                     <a href="{{route('questions.create')}}" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="far fa-eye"></i></a>
                                                </td>
                                            </tr>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{ trans('exams.delete test') }}</h5>
