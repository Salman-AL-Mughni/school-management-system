                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-success">{{trans('Students_trans.Current grade level')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.current school year')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.current class')}}</th>
                                            <th class="alert-success">{{trans('Students_trans.The current academic section')}}</th>
