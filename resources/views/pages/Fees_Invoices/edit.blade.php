...
@section('css')
    @toastr_css
@section('title')
{{ trans('Fees_Invoices.Tuition fee adjustment') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('Fees_Invoices.Fee type') }}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ trans('Fees_Invoices.the amount') }}</label>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{ trans('Fees_Invoices.the amount') }}</label>
