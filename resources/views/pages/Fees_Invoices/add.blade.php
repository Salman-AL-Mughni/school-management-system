...
@section('css')
    @toastr_css
@section('title')
{{ trans('Fees_Invoices.Add new fees') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('Fees_Invoices.Add new fees') }} {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2">{{ trans('Fees_Invoices.name') }}</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Fees_Invoices.Fee type') }}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="fee_id" required>
                                                            <option value="">-- {{ trans('Fees_Invoices.Choose from the list') }} --</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('Fees_Invoices.the amount') }}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{ trans('Fees_Invoices.Statement') }}</label>
                                                    <div class="box">
