...
@section('css')
    @toastr_css
@section('title')
{{ trans('fees.Tuition fee adjustment') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('Fees.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputState">{{ trans('fees.Educational level') }}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ trans('fees.Classroom') }}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ trans('fees.Fee type') }}</label>
                                <select class="custom-select mr-sm-2" name="Fee_type">
                                    <option value="1">{{ trans('fees.Tuition fees') }}</option>
                                    <option value="2">{{ trans('fees.bus fee') }}</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary">{{ trans('fees.Confirm') }}</button>
