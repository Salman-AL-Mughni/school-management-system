...
@section('css')
    @toastr_css
@section('title')
{{ trans('receipt.Amendment of receipt voucher') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('receipt.Amendment of receipt voucher') }} : <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{ trans('receipt.the amount') }} : <span class="text-danger">*</span></label>
